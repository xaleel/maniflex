...
Full documentation, guides, and the tutorial series are at **[docs.maniflex.dev](https://docs.maniflex.dev)**.

All docs are generated by [mdBook](https://rust-lang.github.io/mdBook). You can run the docs locally with `./docs/mdbook serve` (`./docs/mdbook.exe serve` on Windows), available then on http://localhost:3000
